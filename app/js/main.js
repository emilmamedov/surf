$(function(){
    $('.header_slider').slick({
     ...
     $('<div class="quantity-nav"><div class="quantity-button quantity-up"><img src="img/plis.svg" alt=""></div><div class="quantity-button quantity-down"><img src="img/minus.svg" alt=""></div></div>').insertAfter('.quantity input');
